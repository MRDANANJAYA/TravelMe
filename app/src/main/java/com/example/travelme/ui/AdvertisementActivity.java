...
public class AdvertisementActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_advertisement);
        ...
        mywebview.loadUrl("http://10.0.2.2/travelme/index.php#section-4");
    ...
    private void navigationDrawer() {
        ...
        navigationView.setCheckedItem(R.id.nav_Traveling);
